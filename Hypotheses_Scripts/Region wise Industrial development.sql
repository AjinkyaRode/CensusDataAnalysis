...
select count(occupation_code) amt,occupation_code into occupation_north from employment_new where industry_code = ' Retail trade' and curr_region='North' group by occupation_code;	

select count(occupation_code) amt,occupation_code into occupation_south from employment_new where industry_code = ' Retail trade' and curr_region='South' group by occupation_code;	

select count(occupation_code) amt,occupation_code into occupation_east from employment_new where industry_code = ' Retail trade' and curr_region='East' group by occupation_code;	

select count(occupation_code) amt,occupation_code into occupation_west from employment_new where industry_code = ' Retail trade' and curr_region='West' group by occupation_code;	
